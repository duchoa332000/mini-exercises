...
public class HumanManagement {
    ...
    public static void main(String[] args) {
        ...
        Worker worker3 = new Worker("Hoa", "Pham", 500.0, 7);
        Worker worker4 = new Worker("Han", "Tran", 900.0, 8);
        Worker worker5 = new Worker("Trong", "Ho", 650.0, 8);
        Worker worker6 = new Worker("Y", "Nguyen", 700.0, 8);
        Worker worker7 = new Worker("Duy", "Le", 750.0, 8);
        Worker worker8 = new Worker("Thien", "Nguyen", 850.0, 8);
        Worker worker9 = new Worker("Nhung", "Pham", 750.0, 8);
        ...
        listOfHuman.sort(Human.CompareHuman);
